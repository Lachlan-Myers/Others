...
#define COURSE_SIZE (COURSE_ID_LEN+PROG_ID_LEN+MAX_TITLE_LEN+COURSE_CODE_LEN+2+NUM_TEACHPERIODS+MAX_DESC_LEN)
#define PROG_SIZE (PROG_ID_LEN+PROG_TYPE_LEN+MAX_TITLE_LEN+MAX_TITLE_LEN+PROG_CODE_LEN+2+MODE_LEN+MAX_DESC_LEN+MAX_DESC_LEN)
#define SEM_ONE 0
#define SEM_TWO 1
#define YEAR 2010
